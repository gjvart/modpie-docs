...
title: Latest Features (v0.9.96)
description: Complete guide to the latest features and workflow enhancements added in Modpie and Modpie Plus v0.9.96.
---

# Modpie & Modpie Plus: Latest Features Guide (v0.9.96)
...
## 1. Interactive Mode: Modifier Stack Reordering
...
## 2. Context / Object-Based Modifier Pie Menu (Modpie Plus)
...
## 4. Closed Modifier Management & Pin to Last Feedback
...
## 6. Apply Modifier Workflow & Technical Notes
...
## 7. Stack Sync Naming Symmetry (Modpie Plus)
...
| <kbd>Ctrl</kbd> + <kbd>A</kbd> | Object Mode | **Apply Modifier** (applies active/expanded modifier) | Core (Free & Plus) |
