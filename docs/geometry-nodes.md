...
<div className="media-card">
  <div className="media-container">
    {/* To add your GIF/screenshot: replace below with <img src="/modpie-docs/img/media/gn_tools.gif" alt="Geometry Nodes Tools" /> */}
    <div className="media-placeholder">
      <span className="media-placeholder-icon">🧩</span>
      <span className="media-placeholder-title">Geometry Nodes Tools Showcase GIF</span>
      <span className="media-placeholder-hint">Drop file into static/img/media/gn_tools.gif</span>
    </div>
  </div>
  <p className="media-caption">Figure 14: Keep in File, standalone export, and import tools on Geometry Nodes modifiers.</p>
</div>
